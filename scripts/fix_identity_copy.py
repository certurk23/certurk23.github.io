...
SEARCH_INDEX = """const SEARCH_INDEX = [
  ...
  {t:'topic', title:'VPIN: BVC vs tick rule noise floors', sub:'Experiment note: why the two classifiers disagree', url:'learn/vpin-classifier-noise-floor.html', kw:'vpin bvc tick rule bucket size window noise floor'},
  {t:'topic', title:'HRP drift anatomy', sub:'Experiment note: optimism vs luck in out-of-sample volatility', url:'learn/hrp-drift-anatomy.html', kw:'hrp minimum variance drift covariance shrinkage training length'},
  {t:'topic', title:'DSR: false positives and power', sub:'Experiment note: what the deflation does to best-of-N winners', url:'learn/dsr-trials-experiment.html', kw:'deflated sharpe dsr trials false positive power multiple testing'},
